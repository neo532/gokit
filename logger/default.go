...
func (l *DefaultLogger) WithArgs(kvs ...any) (n Logger) {
	return &DefaultLogger{
		log:        l.log,
		globalArgs: kvs,
		level:      l.level,
...
func (l *DefaultLogger) Debugf(c context.Context, format string, kvs ...any) {
	if l.disabled(LevelDebug) {
		return
	}
	l.log.Log(c, LevelDebug, fmt.Sprintf(format, kvs...), l.globalArgs...)
}
func (l *DefaultLogger) Warnf(c context.Context, format string, kvs ...any) {
	if l.disabled(LevelWarn) {
		return
	}
	l.log.Log(c, LevelWarn, fmt.Sprintf(format, kvs...), l.globalArgs...)
}
func (l *DefaultLogger) Infof(c context.Context, format string, kvs ...any) {
	if l.disabled(LevelInfo) {
		return
	}
	l.log.Log(c, LevelInfo, fmt.Sprintf(format, kvs...), l.globalArgs...)
}
func (l *DefaultLogger) Errorf(c context.Context, format string, kvs ...any) {
	if l.disabled(LevelError) {
		return
	}
	l.log.Log(c, LevelError, fmt.Sprintf(format, kvs...), l.globalArgs...)
}
func (l *DefaultLogger) Fatalf(c context.Context, format string, kvs ...any) {
...
func (l *DefaultLogger) Debug(c context.Context, message string, kvs ...any) {
	if l.disabled(LevelDebug) {
		return
	}
	l.log.Log(c, LevelDebug, message, append(l.globalArgs, kvs...)...)
}
func (l *DefaultLogger) Warn(c context.Context, message string, kvs ...any) {
	if l.disabled(LevelWarn) {
		return
	}
	l.log.Log(c, LevelWarn, message, append(l.globalArgs, kvs...)...)
}
func (l *DefaultLogger) Info(c context.Context, message string, kvs ...any) {
	if l.disabled(LevelInfo) {
		return
	}
	l.log.Log(c, LevelInfo, message, append(l.globalArgs, kvs...)...)
}
func (l *DefaultLogger) Error(c context.Context, message string, kvs ...any) {
	if l.disabled(LevelError) {
		return
	}
	l.log.Log(c, LevelError, message, append(l.globalArgs, kvs...)...)
}
func (l *DefaultLogger) Fatal(c context.Context, message string, kvs ...any) {
	if l.disabled(LevelFatal) {
		return
	}
